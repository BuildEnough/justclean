      ...
      <main id="home">
        ...
        <section className="section intro-section">
          <div className="intro-card">
            ...
            <p>
              청소는 단순히 표면을 닦는 일이 아니라, 고객이 다시 안심하고 사용할 수
              있는 공간을 만드는 일입니다. 저스클린은 현장 상태를 확인하고, 오염도에
              맞는 장비와 방식으로 꼼꼼하게 작업합니다.
            </p>
          </div>
            ...
            {beforeAfterList.map((item) => (
              <article className="before-after-card" key={item.title}>
                ...
                <div className="compare-grid">
                  <SmartImage src={item.before} alt={`${item.title} 전`} label="Before" />
                  <SmartImage src={item.after} alt={`${item.title} 후`} label="After" />
                </div>
              </article>
            ))}
          </div>
        ...
        <section id="contact" className="contact-section">
          <div className="contact-inner">
            ...
            <h2>청소 상담이 필요하신가요?</h2>
            <p>
              공간 사진과 원하는 청소 범위를 보내주시면 더 빠르게 상담이 가능합니다.
            </p>
            ...
            <div className="contact-buttons">
              ...
              <a className="btn btn-outline-white" href={`sms:${business.phoneHref}`}>
                문자 상담하기
              </a>
              <a
